...
<!-- <html class="no-js" lang="en"> -->
	<!-- سيتم جعلها تتغير حسب اختياراتي -->
...
<head>
   ...
   <!-- تغيير اللاتجاه حسب اللغة -->
						...
						// $current_Language = "ُEnglish";
						// if ($current_Language == "Arabice"){
						// 	echo "RTL Language";
						// }else{
						// 	echo "LTR Language";
						// }
   ...
   <header id="top">
   	...
   	<div class="row">
   		...
   		<div class="header-content twelve columns">
			  ...
			  <!-- تم جعلة ديناميك -->
		      <h1 id="logo-text"><a href="<?php bloginfo("wpurl"); ?>" title="">
				  <?php bloginfo("name"); ?>
			  </a></h1>
				<!-- <p id="intro">Put your awesome slogan here...</p> -->
				<p id="intro" style="color:#000;font-size:18px;">
